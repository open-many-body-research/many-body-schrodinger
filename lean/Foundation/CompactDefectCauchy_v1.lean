...
/-! A coercive form estimate up to one bounded scalar functional makes
approximate null vectors precompact. The scalar functional and the actual
...
theorem approximate_null_cauchy_of_scalar_cauchy
    (A : E →ₗ.[ℂ] E) (l : E →L[ℂ] ℂ) {b C : ℝ} (hb : 0 < b) (hC : 0 ≤ C)
...
#print axioms approximate_null_cauchy_of_scalar_cauchy
